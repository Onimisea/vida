...
export function WhyInvestSection() {
  ...
  return (
    <section id="why-invest" className="py-20 bg-accent">
      <div className="container mx-auto px-4 md:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Why Invest in <span className="text-primary">VIDA</span>
          </h2>
              ...
              <Card className="h-full border-primary/10 hover:border-primary/30 transition-all duration-300">
                <CardHeader>
                  <div className="flex flex-col items-center text-center">
                    {benefit.icon}
                    <CardTitle className="font-playfair">{benefit.title}</CardTitle>
                  </div>
                </CardHeader>
        ...
        >
          ...
          <Button 
            variant="outline" 
            size="lg" 
            className="min-w-[200px] group border-primary text-primary hover:bg-primary/10 hover:text-primary"
